...
<button id="btnBT" type="button">
  <form method="post" action="{{route('user_tailai')}}">@csrf
    <button style="padding: 7px 14px 7px 14px;" id="btnBT" type="submit"><img id="logo" src="../hinh/logo.png" width="97" height="36"></button>
  </form>
</button>

<button id="btnBT" type="button">
  <form method="post" action="{{route('user_gioithieu')}}">@csrf
    <button id="btnBT" type="submit"><a>Giới Thiệu</a></button>
  </form>
</button>
...
<button id="btnBT" type="button">
  <form method="post" action="{{route('user_lienhe')}}">@csrf
    <button id="btnBT" type="submit"><a>Liên Hệ</a></button>
  </form>
</button>
